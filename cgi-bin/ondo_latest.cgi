...
(days, months, weeks) = ondotori.getLatestDataFromWebStorage()
...
<body>
<div id="chart_days" style="width:1000px; height:600px"></div>
<div id="chart_mean" style="width:1000px; height:600px"></div>
<div id="chart_max" style="width:1000px; height:600px"></div>
...
</html>''' % (ondotori.getDaysSeries(days), ondotori.getMeanOfDaySeries(days), ondotori.getMaxOfDaySeries(days)))
